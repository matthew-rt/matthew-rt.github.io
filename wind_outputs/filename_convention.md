...
Location: `wind-outputs/combinations/`
...
### `wind-outputs/combination_summary.csv`
...
### `wind-outputs/zone_results/all_combinations_by_zone.csv`
...
### `wind-outputs/zone_results/step_reductions_by_zone.csv`
...
## Assumptions
- **Power density**: 20 MW/km² (configurable via POWER_DENSITY_MW_PER_KM2 variable)
